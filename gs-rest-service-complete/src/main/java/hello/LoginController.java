...
public class LoginController {
	  ...
	  public Empresa login(	@RequestParam(value="username") final String username,
			  				@RequestParam(value="password") final String password){
		  
		  final MyUserDetailsService myUserDetailService = new MyUserDetailsService();
	      ...
	      final Object obj = auth.getAuthorities();
